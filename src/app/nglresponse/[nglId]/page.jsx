...
import { Send, MessageCircle, Lock, Shield, Zap, Eye, Users, CheckCircle } from "lucide-react";
                ...
                >
                    ...
                    {showSuccess && (
                        <motion.div
                            ...
                            exit={{ opacity: 0, y: -20 }}
                            className='bg-green-50 border border-green-200 rounded-2xl p-6 mb-8 flex items-center gap-3'
                        >
                            <CheckCircle className='w-6 h-6 text-green-600' />
                            <div>
                                <h3 className='text-green-800 font-semibold text-lg'>Message Sent Successfully!</h3>
                                <p className='text-green-700'>Your anonymous message has been delivered safely.</p>
                            </div>
                        </motion.div>
                    )}
                        ...
                        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
                            ...
                            <form onSubmit={handleSubmit} className='space-y-6'>
                                ...
                                <button
                                    ...
                                    className={`w-full py-5 px-8 rounded-2xl font-semibold text-lg transition-all duration-300 flex items-center justify-center gap-3 ${!message.trim() || isLoading
