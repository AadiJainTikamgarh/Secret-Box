  ...
  return (
    <StyledWrapper>
      ...
      <div className="card shadow-[0_0_15px_rgba(0,0,0,0.4)] overflow-x-hidden">
        ...
        <button className=" w-full flex items-center justify-center gap-3 px-5 py-2 bg-white text-gray-700 border-2 border-gray-300 rounded-lg hover:border-gray-400 hover:shadow-md transition-all duration-200 font-medium my-3">
