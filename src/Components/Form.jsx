    ...
    <StyledWrapper>
      <div className="card shadow-[0_0_15px_rgba(0,0,0,0.4)]">
        <div className="form">
          ...
          <button
            className="flex items-center justify-center mt-3 bg-blue-500 text-white font-semibold p-1 px-2 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 w-[100%]"
            onClick={signIn}
          >
